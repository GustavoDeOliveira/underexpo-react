...
Deve ser de um formato suportado pelo tipo da obra
    ...
    /**
     * Callback function to receive the result of the removerConato operation.
     * @callback moduleapi/PerfilApi~removerConatoCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} id id do contato
     * @param {module:api/PerfilApi~removerConatoCallback} callback The callback function, accepting three arguments: error, data, response
     */
    removerConato(id, callback) {
      
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling removerConato");
      }
