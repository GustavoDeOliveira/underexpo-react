...
Deve ser de um formato suportado pelo tipo da obra
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/AtualizacaoContato} opts.body Dados para atualização do canal de contato
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/AtualizacaoObra} opts.body 
     ...
     */
    atualizarObra(id, opts, callback) {
      opts = opts || {};
      let postBody = opts['body'];
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
    ...
    enviarNotificacao(opts, callback) {
      ...
      let formParams = {
        'expoId': opts['expoId'],'autorId': opts['autorId']
      };
