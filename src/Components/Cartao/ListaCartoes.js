    ...
    <Grid container spacing={4}>
      {aoAdicionarElemento
        ? <Grid item key={0} xs={12} sm={6} md={4}>
            <Button onClick={adicionandoElemento ? () => { } : adicionarElemento} disabled={adicionandoElemento} sx={theme => ({ height: '100%', width: '100%', backgroundColor: theme.palette.primary.light, color: theme.palette.text.primary })}>
